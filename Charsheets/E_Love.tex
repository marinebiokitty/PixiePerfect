...
\begin{itemz}[Goals (in roughly descending order of importance)]
	...
	\item Have a long conversation with \cEHead{} about how \cEHead{\they} run\cEHead{\verbs} the Court of Elements. You aren’t opposed to making up, but you are opposed to sweeping the problems you see under the rug.
\end{itemz}
