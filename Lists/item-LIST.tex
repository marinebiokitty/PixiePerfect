...
\NEW{Item}{\iIron}{
  \s\MYname	{A piece of Cold Iron}
  \s\MYnumber	{}
  \s\MYtext	{This is a piece of Cold Iron. It \textbf{HURTS} to touch. Once you let go of it, your hand is damaged such that it cannot be used for anything else until it is healed. There is no public knowledge of how to heal damage from cold iron, or how to handle it without suffering damage. You \textbf{can} conceal the iron in a pocket or box or the like, but these containers will not protect you from damage as the iron eats right through the magic in these things. If you want to try something with the iron for which you have no mechanic, see a GM.}
  }

\NEW{ItemEnvelope}{\iMudCase}{
  \s\MYname	{A Ball of Mud}
  \s\MYnumber	{}
  \s\MYtext	{Open this envelop if you break open the ball of mud. You may break it open simply by declaring that you break it open.}
  \s\MYcontents	{There is a piece of Cold Iron in here! Your character has not yet touched the iron simply by breaking this open.}
	\s\MYitems {\iIron{}}
  }

\NEW{Item}{\iPixieDust}{
	\s\MYname{A unit of Pixie Dust}
	\s\MYtext{This is pixie dust.  It sparkles in all the colors of the rainbow and a few extra.}
}
